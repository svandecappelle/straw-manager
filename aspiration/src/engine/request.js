...
function Display_Request(obj) {
  console.log("____________BEGIN______REQUEST______________")
  console.log("host: " + obj.options.host + ":" + obj.options.port)
  console.log("")
  console.log(obj.options.method + " " + obj.url)

  for (i in obj.options.headers) {
    console.log(i + ": " + obj.options.headers[i]);
  }
  ...
  console.log("____________END______REQUEST______________")
  console.log("")
}
...
function Request(url, opt, post, param) {
  ...
  this.build = function() {
    ...
    if (!proxy || proxy.length == 0) {
      ...
      console.log(id_regiment, '(' + id_client + ')' +
  ...
  //  var w = 0;
      ...
      console.log("[=============================================================================================================================[ Delay ("+w+"ms) ]=================]");

    if (obj.retry > 1)
      w = 2000;
    console.log(id_regiment, " le client (" + id_client + ") attends " + w + "s");
...
*/
      ...
      request(reqObj, function(error, res, html) {
        ...
        if (error) {
          ...
          console.log(id_regiment, ' (' + id_client + ')' + output);
  ...
  this.AfterValidation = function(valid, html) {
    ...
    if (valid == true) {
      ...
      console.log(this.param.id_regiment + "une requetes est incomplete: " + this.url);
      //console.warn(html);
      //process.exit(0);
      this.ReqError(5050);
    }
